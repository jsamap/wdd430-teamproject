...
import { getProducts } from "./lib/data/product.data";
  ...
  return (
    <main className="flex flex-grow flex-col p-0">
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 bg-gradient-to-b from-hhblue-700 to-hhblue-400 text-white">
        ...
        <a
          href="/products"
          className="mt-6 px-6 py-3 bg-white text-hhblue-500 font-semibold rounded-lg shadow hover:bg-hhorange-300 hover:text-black"
        >
          Shop Now
        </a>
      </section>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 justify-center">
          {products.map((product: any) => (
            ...
            >
              ...
              <button
                className="mt-4 px-4 py-2 bg-hhblue-400 text-white rounded 
